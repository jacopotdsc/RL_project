...
def loss_ppo(kldiv_loss, actual_policy, old_policy, beta, omega, k=3):
    ...
    #print(f"PPO loss value: {loss}, kldiv0: {history_kl[0]}, kldiv1: {history_kl[1]}, kldiv2: {history_kl[2]}")
    #print(f"actual_policy: {actual_policy},\nold_policy: {old_policy}\n")
    return loss
